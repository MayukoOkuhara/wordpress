		...
		<div id="sideContentOuter">
			...
			<aside class="topicBanner"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/
images/banner01.png" alt="歴史下町探訪"></a>
<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/
images/banner02.png" alt="アニメ大好きぐるり旅"></a>
			</aside>
		</div>
	</section>
	<!--./middle-->
...
<footer>
	<div class="container">
		...
		<small class="copyright">Copyright &copy; 201X TOKYO観光ツーリスト.</small> </div>
</footer>
</body>
</html>